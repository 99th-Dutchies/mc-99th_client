...
import nl._99th_dutchclient.gui.widget.HotkeyList;
...
public class OptionsHotkeysScreen extends SettingsScreen
{
    ...
    {
        super(screen, settings, new TranslationTextComponent("99thdc.options.hotkeys"));
    }
    ...
    protected void init()
    {
        ...
        this.addButton(new Button(this.width / 2 - 155, this.height - 27, 150, 20, new TranslationTextComponent("99thdc.options.hotkeys.add"), (p_223703_1_) ->
        {
            KeyBinding kb = new KeyBinding("99thdc.hotkeys.hotkey" + this.minecraft.gameSettings._99thHotkeys.size(), -1, "key.categories.99thdchotkeys");
