...
import nl._99th_dutchclient.gui.widget.EventTriggerList;
...
public class OptionsEventTriggersScreen extends SettingsScreen
{
    ...
    {
        super(screen, settings, new TranslationTextComponent("99thdc.options.eventtriggers"));
    }
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks)
    {
        ...
        drawCenteredString(matrixStack, this.font, new TranslationTextComponent("99thdc.options.chattriggers.response"), this.width / 2 + 20, 45, 16777215);
        drawCenteredString(matrixStack, this.font, new TranslationTextComponent("99thdc.options.chattriggers.delay"), this.width / 2 + 110, 45, 16777215);
