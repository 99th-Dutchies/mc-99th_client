...
import nl._99th_dutchclient.gui.widget.CustomCommandsList;
...
public class OptionsCustomCommandsScreen extends SettingsScreen
{
    ...
    {
        super(screen, settings, new TranslationTextComponent("99thdc.options.customcommands.title"));
    }
    ...
    protected void init()
    {
        ...
        this.addButton(new Button(this.width / 2 - 155, this.height - 27, 150, 20, new TranslationTextComponent("99thdc.options.customcommands.add"), (p_223703_1_) ->
        {
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks)
    {
        ...
        drawCenteredString(matrixStack, this.font, new TranslationTextComponent("99thdc.options.customcommands.command"), this.width / 2 - 95, 45, 16777215);
        drawCenteredString(matrixStack, this.font, new TranslationTextComponent("99thdc.options.customcommands.response"), this.width / 2 + 30, 45, 16777215);
