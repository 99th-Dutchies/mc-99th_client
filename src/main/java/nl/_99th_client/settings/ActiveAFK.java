...
{
    OFF(0, "99thclient.options.ACTIVE_AFK.off"),
    ALWAYS(1, "99thclient.options.ACTIVE_AFK.always"),
    AFKONLY(2, "99thclient.options.ACTIVE_AFK.AFKonly"),
    ACTIVEONLY(3, "99thclient.options.ACTIVE_AFK.ActiveOnly");
