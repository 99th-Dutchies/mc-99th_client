...
import nl._99th_client.gui.widget.ChatFilterList;
...
public class OptionsChatFiltersScreen extends SettingsScreen
{
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks)
    {
        ...
        drawCenteredString(matrixStack, this.font, new TranslationTextComponent("99thclient.options.chatfilters.regex"), this.width / 2 - 105, 50, 16777215);
        drawCenteredString(matrixStack, this.font, new TranslationTextComponent("99thclient.options.chatfilters.activePlayer"), this.width / 2 + 80, 50, 16777215);
        drawCenteredString(matrixStack, this.font, new TranslationTextComponent("99thclient.options.chatfilters.activeChat"), this.width / 2 + 160, 50, 16777215);
