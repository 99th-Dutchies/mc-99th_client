...
public class EventTriggerList extends AbstractOptionList<EventTriggerList.Entry>
{
    ...
    public class EventTriggerEntry extends Entry
    {
        ...
        {
            this.index = index;
            this.label = new TranslationTextComponent("99thclient.options.eventtriggers." + eventTrigger.trigger.getString());
            ...
            this.responseField = new TextFieldWidget(
                    ...
                    120,
                    20,
                    new TranslationTextComponent("99thclient.options.eventtriggers.response"))
            {
            ...
            this.delayField = new TextFieldWidget(
                    ...
                    50,
                    20,
                    new TranslationTextComponent("99thclient.options.eventtriggers.delay"))
            {
                protected IFormattableTextComponent getNarrationMessage()
                {
                    return super.getNarrationMessage().appendString(". ");
